...
public class Databasedocsach extends SQLiteOpenHelper {
    ...
    //Biến Sách
    private static String TABLE_SACH = "sach";
    private static String ID_SACH = "idsach";
    private static String TEN_SACH = "tieude";
    ...
    //Biến lưu câu lệnh tạo bảng sách
    private String SQLQuery1 = "CREATE TABLE "+ TABLE_SACH +" ( "+ID_SACH+" integer primary key AUTOINCREMENT, "
            +TEN_SACH+" TEXT UNIQUE, "
            +NOI_DUNG+" TEXT, "
    ...
    //Insert Sách
    private String SQLQuery4 = "INSERT INTO sach VALUES (null,'Rùa và Thỏ','Phần 1:\n" +
            "\n" +
    ...
    private String SQLQuery5 = "INSERT INTO sach VALUES (null,'Củ cải trắng','Mùa đông đã đến rồi trời lạnh buốt, Thỏ con không có gì để ăn cả. Thỏ con mặc áo vào rồi ra ngoài kiếm thức ăn. Nó đi mãi đi mãi cuối cùng cũng tìm được hai củ cải trắng. Thỏ con reo lên:\n" +
            "\n" +
    ...
    private String SQLQuery6 = "INSERT INTO sach VALUES (null,'Dê đen và dê trắng','Dê đen và Dê trắng cùng sống trong một khu rừng. Hàng ngày, cả hai thường đến uống nước và tìm cái ăn ở trong khu rừng quen thuộc.\n" +
            "\n" +
    ...
    private String SQLQuery7 = "INSERT INTO sach VALUES (null,'Chú bé chăn cừu','Một chú bé chăn cừu cho chủ thả cừu gần một khu rừng rậm cách làng không xa lắm. Chăn cừu được ít lâu, chú cảm thấy công việc chăn cừu thực là nhàm chán. Tất cả mọi việc chú có thể làm để giải khuây là nói chuyện với con chó hoặc thổi chiếc sáo chăn cừu của mình.\n" +
            "\n" +
    ...
    public void onCreate(SQLiteDatabase db) {
        //Thực hiện câu lệnh truy vấn khi không trả về kết quả
        db.execSQL(SQLQuery);
